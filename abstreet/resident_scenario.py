...
def generate9to5(residents):
    ...
    for i in range(residents):
        ...
        # the assumption is that there is one person per home, multiple people per workplace
        home_index = homes.index[((homes['Latitude'] == home[0]) & (homes['Longitude'] == home[1]))][0]
